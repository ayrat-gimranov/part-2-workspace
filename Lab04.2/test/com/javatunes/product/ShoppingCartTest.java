...
public class ShoppingCartTest {
  ...
  /**
   * MusicItem-only shopping cart. May be needed if we need to invoke MusicItem-specific
   * functionality. NOTE: we would of course do some OO analysis and try to avoid working with
   * MusicItem directly (see testProductCart above). However, our ShoppingCart should be able to
   * handle such a case.
   */
  @Test
  ...
  /**
   * MediaPlayer-only shopping cart. See comments above for MusicItem cart.
   */
  @Test
